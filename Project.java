...
public class Project extends JFrame implements ActionListener {
	...
	Project (String atype, String meter) {
		this.atype=atype;
		this.meter=meter;
		setExtendedState(JFrame.MAXIMIZED_BOTH);//frame open full screen
		...
		ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon4.png"));
		...
		ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon9.png"));
		...
		JMenuItem updateinformation = new JMenuItem("Upadte Information");
		...
		paybill.setMnemonic('F');
		 paybill.addActionListener(this);
		paybill.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,ActionEvent.CTRL_MASK));
		user.add(paybill);
	...
	}else if(msg.equals("Upadte Information")) {
